...
.header-prompt-name { font-size: 0.9em; color: #b8860b; font-family: 'Segoe UI', sans-serif; font-style: italic; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; padding: 0 4px; }
          ...
          if (Array.isArray(parsed)) {
            const valid = parsed.filter(
              (m) =>
                m &&
                typeof m.id === "string" &&
                (m.provider === "nano-gpt" || m.provider === "openrouter"),
            );
